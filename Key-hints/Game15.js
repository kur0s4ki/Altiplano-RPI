...
Objectives:
Sur un écran s'affichent des formes et des couleurs. Des boutons correspondant se trouvent dans la pièce. 
Les joueurs doivent appuyer sur les formes de couleur correspondantes.
...
let fouras_sentence = "Les bonnes réponses dans la salle tu trouveras";
let game_time = 3;
let cell_number = 15;
let game_name = "Geometrie";
