...
Objectives:
L'une des épreuves les plus physiques de l'histoire du fort. À réserver aux athlètes ! 
La clé se trouve au fond de la cellule, accrochée en hauteur. Pour l'atteindre, le candidat doit progresser à la force des bras 
sur un parcours composé de différents agrès (barres, échelles horizontales, anneaux...). 
2 chemins sont à priori possibles mais l'un d'eux est piégé. Si le candidat tombe, il doit naturellement recommencer du début.
