...
Objectives:
Un bouton se trouve à la fin du parcours. Pour l'atteindre, le joueur va devoir sauter d'éléments en éléments
 mais ceux-ci se révèlent être mobiles et très peu stables. En cas de chute, il devra recommencer du début.
*/
...
let fouras_sentence = "De champignon en champignons tu progresseras";
let game_time = 3;
let cell_number = 22;
let game_name = "Pays des merveilles";
